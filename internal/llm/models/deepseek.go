...
// GORILLA CULL (2026-08-21): the hand-written DeepSeek model list that lived here
// is gone. Its models are now FETCHED from DeepSeek itself — see
...
// /home/gorilla/Agents.Work.Trash/gorilla-opencode-provider-cull-26-08-21-11-58/models/hardcoded-deepseek.go
