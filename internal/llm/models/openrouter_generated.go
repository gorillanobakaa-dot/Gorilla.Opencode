...
var OpenRouterGeneratedModels = map[ModelID]Model{
	...
	OpenRouterAmazonNova2LiteV1: {
		...
		Description:         "$0.3/$2.5 per 1M — research/admin work (vendor: \"reasoning\") — Nova 2 Lite is a fast, cost-effective reasoning model for everyday workloads that can process text, images, and videos to generate text (1000K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterAmazonNovaLiteV1: {
		...
		Description:         "$0.06/$0.24 per 1M — UNTESTED for coding work — use at your own risk (300K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterAmazonNovaMicroV1: {
		...
		Description:         "$0.04/$0.14 per 1M — UNTESTED for coding work — use at your own risk (128K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterAnthropicClaudeOpus4: {
		...
		Description:         "$15.0/$75.0 per 1M — mentions coding (vendor: \"coding\") — Claude Opus 4 is benchmarked as the world’s best coding model, at time of release, bringing sustained performance on complex, long-running tasks and agent workflows (200K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterAnthropicClaudeOpus48: {
		...
		Description:         "$5.0/$25.0 per 1M — research/admin work (vendor: \"reasoning\") — Claude Opus 4 (1000K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterDeepseekDeepseekChatV31: {
		...
		Description:         "$0.25/$0.95 per 1M — research/admin work (vendor: \"reasoning\") — DeepSeek-V3 (163K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterDeepseekDeepseekV31Terminus: {
		...
		Description:         "$0.3/$1.0 per 1M — UNTESTED for coding work — use at your own risk (163K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterDeepseekDeepseekV32Exp: {
		...
		Description:         "$0.27/$0.41 per 1M — UNTESTED for coding work — use at your own risk (163K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterDeepseekDeepseekV4Flash0731: {
		...
		Description:         "$0.09/$0.18 per 1M — mentions coding (vendor: \"coding\") — DeepSeek V4 Flash 0731 is a sparse mixture-of-experts model from DeepSeek, with 13B active parameters out of 284B total (1048K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterGoogleGemma426bA4bIt: {
		...
		Description:         "$0.07/$0.34 per 1M — shit tier for code — general instruct model, no coding specialisation (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterIbmGraniteGranite418b: {
		...
		Description:         "$0.05/$0.10 per 1M — UNTESTED for coding work — use at your own risk (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterInclusionaiLing261t: {
		...
		Description:         "$0.07/$0.62 per 1M — UNTESTED for coding work — use at your own risk (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterInclusionaiLing26Flash: {
		...
		Description:         "$0.01/$0.03 per 1M — UNTESTED for coding work — use at your own risk (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMetaLlamaLlama4Maverick: {
		...
		Description:         "$0.20/$0.80 per 1M — UNTESTED for coding work — use at your own risk (1048K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMetaLlamaLlama4Scout: {
		...
		Description:         "$0.10/$0.30 per 1M — UNTESTED for coding work — use at your own risk (1310K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMetaMuseSpark11: {
		...
		Description:         "$1.2/$4.2 per 1M — research/admin work (vendor: \"reasoning\") — Muse Spark 1 (1048K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMinimaxMinimaxM1: {
		...
		Description:         "$0.6/$2.2 per 1M — research/admin work (vendor: \"reasoning\") — MiniMax-M1 is a large-scale, open-weight reasoning model designed for extended context and high-efficiency inference (1000K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMinimaxMinimaxM2: {
		...
		Description:         "$0.3/$1.0 per 1M — mentions coding (vendor: \"coding\") — MiniMax-M2 is a compact, high-efficiency large language model optimized for end-to-end coding and agentic workflows (204K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMinimaxMinimaxM21: {
		...
		Description:         "$0.3/$1.2 per 1M — mentions coding (vendor: \"coding\") — MiniMax-M2 (204K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMinimaxMinimaxM25: {
		...
		Description:         "$0.22/$0.90 per 1M — mentions coding (vendor: \"coding\") — MiniMax-M2 (204K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMistralaiMistralMedium3: {
		...
		Description:         "$0.4/$2.0 per 1M — research/admin work (vendor: \"reasoning\") — Mistral Medium 3 is a high-performance enterprise-grade language model designed to deliver frontier-level capabilities at significantly reduced operational cost (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMistralaiMistralMedium31: {
		...
		Description:         "$0.4/$2.0 per 1M — UNTESTED for coding work — use at your own risk (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMistralaiMistralSmall2603: {
		...
		Description:         "$0.15/$0.60 per 1M — research/admin work (vendor: \"reasoning\") — Mistral Small 4 is the next major release in the Mistral Small family, unifying the capabilities of several flagship Mistral models into a single system (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMistralaiMistralSmall3224bInstruct: {
		...
		Description:         "$0.09/$0.25 per 1M — UNTESTED for coding work — use at your own risk (256K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMoonshotaiKimiK2: {
		...
		Description:         "$0.6/$2.3 per 1M — UNTESTED for coding work — use at your own risk (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMoonshotaiKimiK20905: {
		...
		Description:         "$0.6/$2.5 per 1M — UNTESTED for coding work — use at your own risk (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterMoonshotaiKimiK2Thinking: {
		...
		Description:         "$0.6/$2.5 per 1M — research/admin work (vendor: \"reasoning\") — Kimi K2 Thinking is Moonshot AI’s most advanced open reasoning model to date, extending the K2 series into agentic, long-horizon reasoning (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterNexAgiNexN2Pro: {
		...
		Description:         "$0.2/$1.0 per 1M — research/admin work (vendor: \"agentic\") — Nex-N2-Pro is an agentic mixture-of-experts model from Nex AGI, with 17B active parameters out of 397B total (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterNvidiaNemotron3Ultra550bA55bFree: {
		...
		Description:         "FREE — research/admin work (vendor: \"reasoning\") — NVIDIA Nemotron 3 Ultra is an open frontier-reasoning and orchestration model from NVIDIA, with 55B active parameters out of 550B total (MoE) (1000K ctx)",
		Rank:                1,
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiGpt41Mini: {
		...
		Description:         "$0.4/$1.6 per 1M — UNTESTED for coding work — use at your own risk (1047K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiGpt41Nano: {
		...
		Description:         "$0.10/$0.40 per 1M — UNTESTED for coding work — use at your own risk (1047K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiGpt51: {
		...
		Name:                "OpenAI: GPT-5.1",
		Description:         "$1.2/$10.0 per 1M — research/admin work (vendor: \"reasoning\") — GPT-5 (400K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiGpt52: {
		...
		Name:                "OpenAI: GPT-5.2",
		Description:         "$1.8/$14.0 per 1M — research/admin work (vendor: \"agentic\") — GPT-5 (400K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiGpt52Chat: {
		...
		Description:         "$1.8/$14.0 per 1M — research/admin work (vendor: \"reasoning\") — GPT-5 (128K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiGpt53Chat: {
		...
		Description:         "$1.8/$14.0 per 1M — UNTESTED for coding work — use at your own risk (128K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiGpt54: {
		...
		Name:                "OpenAI: GPT-5.4",
		Description:         "$2.5/$15.0 per 1M — UNTESTED for coding work — use at your own risk (1050K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiGpt54Nano: {
		...
		Description:         "$0.2/$1.2 per 1M — UNTESTED for coding work — use at your own risk (400K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiGpt54Pro: {
		...
		Description:         "$30.0/$180.0 per 1M — research/admin work (vendor: \"reasoning\") — GPT-5 (1050K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiGptOss20bFree: {
		...
		Description:         "FREE — UNTESTED for coding work — use at your own risk (131K ctx)",
		Rank:                12,
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiO3MiniHigh: {
		...
		Description:         "$1.1/$4.4 per 1M — research/admin work (vendor: \"reasoning\") — OpenAI o3-mini-high is the same model as o3-mini with reasoning_effort set to high (200K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiO4Mini: {
		...
		Name:                "OpenAI: o4 Mini",
		Description:         "$1.1/$4.4 per 1M — research/admin work (vendor: \"reasoning\") — OpenAI o4-mini is a compact reasoning model in the o-series, optimized for fast, cost-efficient performance while retaining strong multimodal and agentic capabilities (200K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenaiO4MiniHigh: {
		...
		Description:         "$1.1/$4.4 per 1M — research/admin work (vendor: \"reasoning\") — OpenAI o4-mini-high is the same model as o4-mini with reasoning_effort set to high (200K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterOpenrouterAuto: {
		...
		Name:                "Auto Router",
		Description:         "$-1000000.00/$-1000000.00 per 1M — UNTESTED for coding work — use at your own risk (2000K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterPoolsideLagunaXs21Free: {
		...
		Description:         "FREE — mentions coding (vendor: \"coding\") — Laguna XS 2 (262K ctx)",
		Rank:                7,
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen314b: {
		...
		Name:                "Qwen: Qwen3 14B",
		Description:         "$0.23/$0.91 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3-14B is a dense 14 (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3235bA22b: {
		...
		Description:         "$0.5/$1.8 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3-235B-A22B is a 235B parameter mixture-of-experts (MoE) model developed by Qwen, activating 22B parameters per forward pass (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3235bA22b2507: {
		...
		Description:         "$0.09/$0.55 per 1M — UNTESTED for coding work — use at your own risk (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen330bA3b: {
		...
		Description:         "$0.12/$0.50 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3, the latest generation in the Qwen large language model series, features both dense and mixture-of-experts (MoE) architectures to excel in reasoning, multilingual suppo… (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen330bA3bInstruct2507: {
		...
		Description:         "$0.05/$0.19 per 1M — UNTESTED for coding work — use at your own risk (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen330bA3bThinking2507: {
		...
		Description:         "$0.2/$2.4 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3-30B-A3B-Thinking-2507 is a 30B parameter Mixture-of-Experts reasoning model optimized for complex tasks requiring extended multi-step thinking (81K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen332b: {
		...
		Name:                "Qwen: Qwen3 32B",
		Description:         "$0.08/$0.28 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3-32B is a dense 32 (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen38b: {
		...
		Name:                "Qwen: Qwen3 8B",
		Description:         "$0.12/$0.45 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3-8B is a dense 8 (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3Coder30bA3bInstruct: {
		...
		Description:         "$0.07/$0.27 per 1M — CAN CODE (vendor: \"code generation\") — Qwen3-Coder-30B-A3B-Instruct is a 30 (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3Max: {
		...
		Name:                "Qwen: Qwen3 Max",
		Description:         "$0.8/$3.9 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3-Max is an updated release built on the Qwen3 series, offering major improvements in reasoning, instruction following, multilingual support, and long-tail knowledge cove… (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3Vl235bA22bInstruct: {
		...
		Description:         "$0.2/$1.9 per 1M — shit tier for code — vision/image model (vendor: \"vision-language\") — Qwen3-VL-235B-A22B Instruct is an open-weight multimodal model that unifies strong text generation with visual understanding across images and vid… (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3Vl235bA22bThinking: {
		...
		Description:         "$0.4/$4.0 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3-VL-235B-A22B Thinking is a multimodal model that unifies strong text generation with visual understanding across images and video (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3Vl30bA3bInstruct: {
		...
		Description:         "$0.15/$0.60 per 1M — UNTESTED for coding work — use at your own risk (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3Vl30bA3bThinking: {
		...
		Description:         "$0.2/$2.4 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3-VL-30B-A3B-Thinking is a multimodal model that unifies strong text generation with visual understanding for images and videos (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3Vl8bThinking: {
		...
		Description:         "$0.2/$2.1 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3-VL-8B-Thinking is the reasoning-optimized variant of the Qwen3-VL-8B multimodal model, designed for advanced visual and textual reasoning across complex scenes, documen… (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3627b: {
		...
		Description:         "$0.6/$3.6 per 1M — UNTESTED for coding work — use at your own risk (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen3635bA3b: {
		...
		Description:         "$0.1/$1.0 per 1M — UNTESTED for coding work — use at your own risk (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen36Plus: {
		...
		Description:         "$0.3/$1.9 per 1M — UNTESTED for coding work — use at your own risk (1000K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen37Plus: {
		...
		Description:         "$0.3/$1.3 per 1M — UNTESTED for coding work — use at your own risk (1000K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterQwenQwen38Max: {
		...
		Description:         "$2.0/$6.0 per 1M — research/admin work (vendor: \"reasoning\") — Qwen3 (1000K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterRelaceRelaceSearch: {
		...
		Description:         "$1.0/$3.0 per 1M — research/admin work (vendor: \"agentic\") — The relace-search model uses 4-12 `view_file` and `grep` tools in parallel to explore a codebase and return relevant files to the user request (256K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterSakanaFuguUltra: {
		...
		Description:         "$5.0/$30.0 per 1M — research/admin work (vendor: \"orchestration\") — Fugu Ultra is the higher-performance model in Sakana AI's Fugu family (1000K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterTencentHy3: {
		...
		Name:                "Tencent: Hy3",
		Description:         "$0.13/$0.53 per 1M — research/admin work (vendor: \"reasoning\") — Hy3 is a 295B-parameter Mixture-of-Experts model from Tencent (21B active, 192 experts with top-8 routing) built for reasoning, agentic workflows, and real-world production u… (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterTencentHy3Preview: {
		...
		Description:         "$0.06/$0.21 per 1M — research/admin work (vendor: \"agentic\") — Hy3 preview is a high-efficiency Mixture-of-Experts model from Tencent designed for agentic workflows and production use (262K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterThinkingmachinesInklingSmall: {
		...
		Description:         "$0.4/$1.2 per 1M — UNTESTED for coding work — use at your own risk (524K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterZAiGlm45: {
		...
		Name:                "Z.ai: GLM 4.5",
		Description:         "$0.6/$2.2 per 1M — UNTESTED for coding work — use at your own risk (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterZAiGlm45Air: {
		...
		Description:         "$0.13/$0.85 per 1M — UNTESTED for coding work — use at your own risk (131K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterZAiGlm46: {
		...
		Name:                "Z.ai: GLM 4.6",
		Description:         "$0.5/$2.0 per 1M — UNTESTED for coding work — use at your own risk (204K ctx)",
		Provider:            ProviderOpenRouter,
	...
	OpenRouterZAiGlm5: {
		...
		Name:                "Z.ai: GLM 5",
		Description:         "$0.9/$2.6 per 1M — research/admin work (vendor: \"long-horizon\") — GLM-5 is Z (204K ctx)",
		Provider:            ProviderOpenRouter,
		APIModel:            "z-ai/glm-5",
		CostPer1MIn:         0.95,
	...
	OpenRouterZAiGlm51: {
		...
		Name:                "Z.ai: GLM 5.1",
		Description:         "$1.0/$3.0 per 1M — mentions coding (vendor: \"coding\") — GLM-5 (204K ctx)",
		Provider:            ProviderOpenRouter,
