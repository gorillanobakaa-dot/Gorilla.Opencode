...
func osintContent() []osintLine {
	...
	return []osintLine{
		...
		{"", ""},
		{"h2", "What it is"},
		{"", "An ALL-SOURCE intelligence assessment of your question — not a chat answer. \"All-source\" is the"},
		{"", "trade term for fusing different KINDS of source — scholarly, official, corporate, humanitarian,"},
		{"", "news — and weighing them against each other, which is what makes it assessment rather than"},
		{"", "searching. The method is a civilianized version of the cycle real analysis shops run: plan what"},
		{"", "would answer the question, collect, vet, grade, hunt the gaps, then write."},
		{"", ""},
		...
		{"", "follows the UK government's standard for intelligence assessment instead, which separates two"},
		{"", "things most writing muddles together:"},
		{"", "  LIKELIHOOD — how likely the judgement is, in seven fixed words (remote chance, highly"},
		{"", "               unlikely, unlikely, realistic possibility, likely, highly likely, almost"},
		{"", "               certain). No invented percentages, ever."},
		{"", "  CONFIDENCE — how solid the basis is: HIGH, MODERATE or LOW, and which of information base,"},
		{"", "               analytical rigour, or complexity set that level."},
		{"", "So \"highly likely, LOW confidence — one source, uncorroborated\" is a legitimate answer, and a"},
		{"", "far more useful one than a confident paragraph hiding the same thin evidence. Every line is"},
		{"", "also marked FACT, INFERENCE or ASSUMPTION, and rival explanations are tested, not ignored."},
		{"", ""},
