...
Everything you can type, what it does, and which two spend money. You can read
the same list inside the program with `/help`, and it ships in the package at
`/usr/share/doc/gorilla-opencode/COMMANDS.md`.
